...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Erc.Households.Domain.Marker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Erc.Households.Domain.AccountingPoints.AccountingPoint", b =>
                {
                    ...
                    b.OwnsMany("Erc.Households.Domain.AccountingPoints.AccountingPointMarker", "Markers", b1 =>
                        {
                            ...
                            b1.HasKey("AccountingPointId", "Id")
                                .HasName("pk_accounting_point_markers");

                            b1.HasIndex("MarkerId")
                                .HasDatabaseName("ix_accounting_point_markers_marker_id");

                            b1.ToTable("accounting_point_markers");

                            b1.WithOwner()
                                .HasForeignKey("AccountingPointId")
                                .HasConstraintName("fk_accounting_point_markers_accounting_points_accounting_point");

                            b1.HasOne("Erc.Households.Domain.Marker", "Marker")
                                .WithMany()
                                .HasForeignKey("MarkerId")
                                .HasConstraintName("fk_accounting_point_markers_markers_marker_id")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();

                            b1.Navigation("Marker");
                        });
