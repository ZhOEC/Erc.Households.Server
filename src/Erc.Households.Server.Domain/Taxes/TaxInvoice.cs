...
namespace Erc.Households.Domain.Taxes
{
    public class TaxInvoice
    {
        ...
        public string ExportToXml()
        {
            ...
            {
                WriteTabElement(writer, "TAB1_A1", tabLine.RowNumber.ToString(), "1");
                WriteTabElement(writer, "TAB1_A8", "20", "1");
                WriteTabElement(writer, "TAB1_A10", tabLine.LiabilitiesAmount.ToString("0.00").Replace(',', '.'), "1");
                WriteTabElement(writer, "TAB1_A20", tabLine.Tax.ToString("0.000000").Replace(',', '.'), "1");
            ...
            static void WriteTabElement(XmlWriter writer, string name, string value, string tab = "0")
            {
